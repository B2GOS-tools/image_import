...
LD_LIBRARY_PATH=./lib/out_host_linux-x86_lib64 ./bin/make_ext4fs -s -T -1 -S tmp/ramdisk/file_contexts -L system -l 838860800 -a system out/system_hack.img system_work/ 2>&1 /dev/null
echo "Done."
